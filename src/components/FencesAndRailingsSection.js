...
const FencesAndRailingsSection = () => (
  <section className="max-w-4xl mx-auto px-4 py-16 text-center">
    <h3 className="text-lg md:text-xl font-semibold mb-6 text-gray-700">FENCES AND RAILINGS</h3>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="bg-white rounded shadow p-8 flex flex-col items-center">
        {/* Fence Icon */}
        <div className="mb-4"><FenceIcon /></div>
        <h4 className="font-bold text-lg mb-2">Fences</h4>
        <p className="text-gray-500 text-sm">Ornamental, Privacy, Pool, Chain Link, Custom (Commercial/Residential)</p>
      </div>
      <div className="bg-white rounded shadow p-8 flex flex-col items-center">
        {/* Ramp Icon */}
        <div className="mb-4"><RampIcon /></div>
        <h4 className="font-bold text-lg mb-2">Ramps</h4>
        <p className="text-gray-500 text-sm">Custom ramps and accessibility solutions</p>
      </div>
    </div>
  </section>
);
