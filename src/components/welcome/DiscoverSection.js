...
const DiscoverSection = () => (
  <section className="relative py-16 bg-gray-100 text-center overflow-hidden">
    ...
    <div className="relative z-10 max-w-3xl mx-auto px-4">
      <h3 className="text-2xl md:text-3xl font-bold mb-4 text-white">DISCOVER THE<br />IDEAL FENCE FOR YOUR SPACE!</h3>
      <a href="#" className="mt-4 inline-block bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded transition font-semibold text-lg shadow">Contact us</a>
    </div>
  </section>
);
