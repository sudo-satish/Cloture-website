...
const SignatureSection = () => {
  ...
  <section className="w-full bg-white py-12 px-4 flex flex-col md:flex-row items-center justify-center gap-8 max-w-7xl mx-auto">
    <div className="flex-1 flex items-start">
      ...
      <div>
        <h2 className="text-2xl md:text-3xl font-bold mb-4">{t('external_signature')}</h2>
        <p className="mb-2 text-gray-800">{t('hiring_expert')}</p>
        <p className="text-gray-800">{t('cloture_enhances')}</p>
      </div>
    </div>
